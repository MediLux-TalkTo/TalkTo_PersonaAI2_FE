...
class JunhyukChatPage extends StatefulWidget {
  const JunhyukChatPage({super.key});

  @override
  State<JunhyukChatPage> createState() => _JunhyukChatPageState();
}

class _JunhyukChatPageState extends State<JunhyukChatPage> {
  ...
  static const String _personaId = 'cb2ca371-c086-4bda-a703-201a90f48a08';

  String _personaName = '이준혁';
  ...
  Future<void> _toggleRecording() async {
    ...
    try {
      ...
      debugPrint('voice personaId: $_personaId');
